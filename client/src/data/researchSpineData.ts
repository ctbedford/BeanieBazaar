          ...
          content_sections: [
            {
              node_document: {
                ...
                key_findings: [
                  {
                    title: "Deliveroo Platform Profile",
                    critical_takeaway: "Deliveroo offers advertising opportunities via 'Marketer Adverts' and 'Deliveroo Media and Ecommerce', along with robust API capabilities for menu and catalog management that can help with SKU consistency for direct partners.",
                    points: [
                      {
                        text: "Sponsored Listings & Advertising: 'Marketer Adverts' is a cost-per-click (CPC) service for partners to boost visibility in high-traffic spots (Featured, Offers, Popular Brands, search results). Options for continuous or one-off campaigns, automated or manual bidding.",
                        citation: "Deliveroo Learning Centre"
                      },
                      {
                        text: "'Deliveroo Media and Ecommerce': Broader advertising platform launched (initially UK, with Criteo) for consumer FMCG brands, including ads on order tracker page, website, app, and through social/email/push campaigns, alongside sponsored search. Enables brands to provide samples via Editions kitchens and HOP stores.",
                        citation: "New Digital Age"
                      },
                      {
                        text: "API Feeds & Integration: Offers extensive API suites: 'Partner Platform Suite' (orders, menus, site status for restaurants), 'Retail Platform Suite' (catalogue API for up to 30k items, picking API for grocery/retail), and 'Signature Suite' (custom delivery experiences using Deliveroo couriers).",
                        citation: "Deliveroo API Docs"
                      },
                      {
                        text: "Menu API allows updates to stock status, pictures, prices, POS IDs, allergen info from partner's in-store system.",
                        citation: "Deliveroo API Docs"
                      },
                      {
                        text: "SKU Management: Catalogue API for retail partners helps manage master catalogues, which should aid in SKU consistency for direct partners. General challenge for brands if products are listed by many independent restaurants/stores with varying data quality.",
